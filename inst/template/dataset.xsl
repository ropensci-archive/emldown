...
<xsl:template name="dataset" match="/">
  ...
  <h2><a href="#datatable">Data table(s) <span class="badge"><xsl:value-of select="count(//dataTable)" /></span></a></h2>
  <h2><a href="#otherentity">Other entity(ies) <span class="badge"><xsl:value-of select="count(//otherEntity)" /></span></a></h2>
